...
namespace utils
{
	...
	namespace mem
	{
		...
		bool InvokeRemoteFunction(DWORD pid, uint64_t func_addr,ControlCmd cmd)
		{
			return MemStub::RemoteCallFunction(pid, func_addr, reinterpret_cast<uintptr_t>(&cmd), sizeof(ControlCmd));
		}
	}

	namespace normal
	{
		void CopyStringToClipboard(HWND hwnd,const char* str)
		{
