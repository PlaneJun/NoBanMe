...
public:
	...
	bool create(const wchar_t* pipe_name);

	bool close();

	void client_connect(const wchar_t* pipe_name);

	bool client_disconnect(const wchar_t* pipe_name);
