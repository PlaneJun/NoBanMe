...
void WindowsWidget::OnPaint()
{
    ...
    {
        if (ImGui::BeginTable("#childwndinfo", 13,  ImGuiTableFlags_ScrollX | ImGuiTableFlags_ScrollY | ImGuiTableFlags_BordersV, ImVec2(0.0f, 0), 0.0f))
        {
...
WindowItem WindowsWidget::AddNode(HWND hwnd)
{
    WindowItem wnd{};
    wnd.SetHwnd(hwnd);
